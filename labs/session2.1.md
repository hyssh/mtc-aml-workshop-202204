...
> Original document located in: https://docs.microsoft.com/en-us/azure/machine-learning/concept-designer
...
- [What is Azure Machine Learning designer?](#what-is-azure-machine-learning-designer)
  - [Model training and deployment](#model-training-and-deployment)
  - [Pipeline](#pipeline)
    - [Pipeline draft](#pipeline-draft)
    - [Pipeline run](#pipeline-run)
  - [Datasets](#datasets)
  - [Module](#module)
  - [<a name="compute"></a> Compute resources](#-compute-resources)
  - [Deploy](#deploy)
  - [Publish](#publish)
...
![Workflow diagram for training, batch inference, and real-time inference in the designer](../images/designer-workflow-diagram.png)
...
:::image type="content" source="../images/properties.png" alt-text="Module properties":::
