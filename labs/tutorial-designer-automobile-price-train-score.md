...
1. Select **Designer**.
    ...
    ![Screenshot of the visual workspace showing how to access the designer](../images/launch-designer.png)
...
1. Next to the pipeline name, select the **Gear icon** ![Screenshot of the gear icon](../images/gear-icon.png) at the top of the canvas to open the **Settings** pane.
...
1. Select the dataset **Automobile price data (Raw)**, and drag it onto the canvas.
   ...
   ![Drag data to canvas](../images/drag-data.gif)
...
1. In the lower right, select **Save** to close the column selector.
    ...
    ![Exclude a column](../images/exclude-column.png)
...
1. In the module details pane to the right of the canvas, select the **Comment** box, and enter *Remove missing value rows*. 
    ...
    ![pieline-clean](../images/pipeline-clean.png)
...
1. In the text box, enter *price* to specify the value that your model is going to predict.
    ...
    ![pipeline-train-graph](../images/pipeline-train-graph.png)
...
1. Connect the output of the **Score Model** module to the left input of **Evaluate Model**. 
    ...
    ![pipeline-final-graph](../images/pipeline-final-graph.png)
...
1. Right-click the **Score Model** module, and select **Visualize** > **Scored dataset** to view its output.
    ...
    ![score-result](../images/score-result.png)
